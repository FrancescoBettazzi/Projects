...
int main() {
    ...
    auto c = std::make_shared<User>(User("Annalisa"));
    ...
    try {
        ...
        a->sendMessage(b, std::make_shared<Message>(Message(a->getName(), b->getName(), "Stasera c'è la partita di calcetto...")));
        a->sendMessage(b, std::make_shared<Message>(Message(a->getName(), b->getName(), "Vuoi venire a fare il tifo?")));
